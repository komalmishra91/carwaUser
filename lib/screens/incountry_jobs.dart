...
class InCountryJobs extends StatefulWidget {
  @override
  _InCountryJobsState createState() => _InCountryJobsState();
}

class _InCountryJobsState extends State<InCountryJobs> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: HelperUtility.appBar(title: "In Country",context: context),
      body: SafeArea(
        child: Padding(
          ...
          child: ListView(
            ...
            children: [
             ...
             selectedindex==2? _awardedListView(context, "Pay", Row(
               children: [
                 Container(
                   padding: EdgeInsets.only(left: 100,right: 100,top: 10,bottom: 10),
                   decoration: BoxDecoration(
                 ...
                 SizedBox(width: 10,),
                 Image.asset(AppImages.mapImg,height: 30,),
                 SizedBox(width: 10,),
                 InkWell(
                   onTap: (){
                     ...
                     child: Image.asset(AppImages.chatImg,height: 30,))
               ],
             ),SizedBox()):
                 selectedindex == 3?_completedListView(context, SizedBox()):
                     selectedindex == 4?_completedListView(context, InkWell(
                       onTap: (){
                         Navigator.push(context,
                             MaterialPageRoute(builder:
                                 (context) =>
                         ...
                         child: Image.asset(AppImages.chatImg))):
...
_awardedListView(context,String buttonTxt,Widget bottomRow,Widget awarded){
  return Column(
    children: [
      Card(
        elevation: 4,
